...
<title>Rock Paper Scissors!!!</title>																																																						<html>
   ...
   <body>
      ...
      <a href="#" onclick="playRoshambo('rock')"> rock1 </a>
      <a href="#" onclick="playRoshambo('paper')"> paper2 </a>
      <a href="#" onclick="playRoshambo('scissors')"> scissors3 </a>
	  
	  
      <p><a href="https://www.ynet.co.il/">ynet new</a></p>
      <button type="button">Click Me test! daniel and matan</button>
